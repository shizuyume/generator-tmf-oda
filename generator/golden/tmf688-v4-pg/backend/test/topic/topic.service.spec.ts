...
import * as hooks from '../../src/topic/topic.hooks';
...
const SUPPLIED_AT_TYPE = 'CustomTopic';
 ...
 */
const SORT_KEY = 'contentQuery';
const SELECTED = 'contentQuery';
/** One the client did not ask for, which selection must then drop. */
const NOT_SELECTED = 'headerQuery';
...
describe('TopicService', () => {
  ...
  describe('create', () => {
    ...
    it('keeps a client-supplied id and defaults @type to Topic', async () => {
    ...
    it('builds from the payload the beforeCreate hook returns, not the dto', async () => {
      ...
      expect(persisted.contentQuery).toBe('res-from-hook');
    });
  });
