...
import { GeographicAddress } from './geographic-address.entity';
 ...
 */
@Entity('geographic_sub_address2')
export class GeographicSubAddress2 {
  ...
  @ManyToOne(() => GeographicAddress, (parent) => parent.geographicSubAddress, {
    onDelete: 'CASCADE',
    nullable: false,
  })
  @JoinColumn({ name: 'geographic_address_id' })
  owner: GeographicAddress;
}
