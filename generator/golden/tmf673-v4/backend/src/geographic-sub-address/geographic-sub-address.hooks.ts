...
import { CreateGeographicSubAddressDto, UpdateGeographicSubAddressDto } from './dto';

/** Runs before the entity is built. Return a modified payload, or undefined. */
export async function beforeCreate(
  dto: Record<string, any> | CreateGeographicSubAddressDto,
...
export async function beforeUpdate(
  id: string,
  dto: Record<string, any> | UpdateGeographicSubAddressDto,
): Promise<Record<string, any> | undefined> {
  return undefined;
}
