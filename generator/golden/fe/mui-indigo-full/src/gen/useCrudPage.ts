 ...
 * loading/error, create/edit/delete + snackbar callback. Emitter page (M4) hanya
 * menghubungkan hooks.list/hooks.create/dst ke api defs resource.
 */
export function useCrudPage<T>(hooks: CrudHooks<T>, options: UseCrudPageOptions = {}) {
  ...
  // ref identity-stabil: hooks/options berubah per render tanpa mengubah perilaku
