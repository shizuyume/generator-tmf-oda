...
// fe-default (tanpa data-grid server-mode terikat) — sort/filter model memakai tipe lokal.
 ...
 * loading/error, create/edit/delete + snackbar callback. Contract props sama untuk semua
 * library (emitter page netral) — versi fe-default tanpa dependensi UI apa pun.
 */
