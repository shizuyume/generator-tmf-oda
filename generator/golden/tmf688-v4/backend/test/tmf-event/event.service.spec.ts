...
import * as hooks from '../../src/tmf-event/event.hooks';
 ...
 */
const ROW_HREF_BASE = '/tmf-api/event/v4/event/res-1';
...
const SUPPLIED_AT_TYPE = 'CustomEvent';
...
const ROW_ID: Record<string, string> = {
  analyticCharacteristic: 'analyticCharacteristic-ref-0',
  relatedParty: 'relatedParty-ref-0',
};

/** Owned collections, whose rows fall back to their own key with no refId. */
const REF_ID_FALLBACK = ['analyticCharacteristic', 'relatedParty'] as const;
...
describe('EventService', () => {
  ...
  describe('create', () => {
    ...
    it('keeps a client-supplied id and defaults @type to Event', async () => {
    ...
    it('leaves the single refs unset and every collection empty when the payload omits them', async () => {
      repo.findOne.mockResolvedValue(entity());
  ...
  describe('findEntity / findOne', () => {
    ...
    it('omits the single refs and returns empty collections when the row carries none', async () => {
